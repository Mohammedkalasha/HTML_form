...
function createButton() {
    ...
    btn.type = 'button'
    btn.setAttribute('class', 'btn btn-primary text-center mt-5')
    btn.onclick = action;
...
function createMultiSelect() {
    ...
    var opt2 = new Option('hamburger', 'hamburger');
    var opt3 = new Option('pizza', 'pizza');
    var opt4 = new Option('spaghetti', 'spaghetti');
    var opt5 = new Option('salad', 'salad');
    opt2.selected = true;
...
function createState() {
    ...
    select.id = 'state'
    select.setAttribute('class', 'form-control col-6')
    var opt1 = new Option('select', 'select');
    opt1.selected = true;
